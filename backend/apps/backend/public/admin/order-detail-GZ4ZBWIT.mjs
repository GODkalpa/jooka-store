...
import {
  ...
  useClaims
} from "./chunk-FAO2XIM6.mjs";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-DNM7M5SM.mjs";
import {
...
var seo = (match) => ({
  title: match.data?.order ? `#${match.data.order.display_id}` : void 0
});
      ...
      Popover2.Content,
      {
        ...
        children: /* @__PURE__ */ jsxs7("div", { className: "flex flex-col", children: [
          !!previous && /* @__PURE__ */ jsxs7("div", { className: "p-3", children: [
            showComparison && /* @__PURE__ */ jsx6("div", { className: "txt-compact-small-plus mb-1", children: t("labels.from") }),
            previous
          ] }),
          !!next && /* @__PURE__ */ jsxs7("div", { className: "border-t-2 border-dotted p-3", children: [
            showComparison && /* @__PURE__ */ jsx6("div", { className: "txt-compact-small-plus mb-1", children: t("labels.to") }),
            next
          ] })
        ] })
      }
  ...
  return useMemo2(() => {
    ...
    for (const payment of payments) {
      ...
      for (const refund of payment.refunds || []) {
        items.push({
          ...
          children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
            /* @__PURE__ */ jsx7(Text6, { size: "small", children: getStylizedAmount(
              refund.amount,
              payment.currency_code
            ) }),
            refund.created_by && /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 text-sm", children: [
              t("fields.by"),
              " ",
              /* @__PURE__ */ jsx7(By, { id: refund.created_by })
            ] })
          ] })
        });
      }
    ...
    for (const fulfillment of order.fulfillments || []) {
      items.push({
        ...
        children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          /* @__PURE__ */ jsx7(FulfillmentCreatedBody, { fulfillment }),
          fulfillment.created_by && /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            /* @__PURE__ */ jsx7(By, { id: fulfillment.created_by })
          ] })
        ] })
      });
      ...
      if (fulfillment.shipped_at) {
        items.push({
          ...
          children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
            /* @__PURE__ */ jsx7(FulfillmentCreatedBody, { fulfillment }),
            fulfillment.marked_shipped_by && /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 text-sm", children: [
              t("fields.by"),
              " ",
              /* @__PURE__ */ jsx7(By, { id: fulfillment.marked_shipped_by })
            ] })
          ] })
        });
      }
    ...
    for (const ret of returns) {
      ...
      items.push({
        ...
        children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          ...
          ret.created_by && !ret.canceled_at && /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            /* @__PURE__ */ jsx7(By, { id: ret.created_by })
          ] })
        ] })
      });
      if (ret.canceled_at) {
      ...
      if (ret.status === "received" || ret.status === "partially_received") {
        items.push({
          ...
          itemsToReturn: ret?.items,
          itemsMap,
          children: /* @__PURE__ */ jsx7(ReturnBody, { orderReturn: ret, isCreated: false, isReceived: true })
        });
      }
    }
    for (const claim of claims) {
      ...
      items.push({
        ...
        itemsMap,
        children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          /* @__PURE__ */ jsx7(ClaimBody, { claim, claimReturn }),
          claim.created_by && !claim.canceled_at && /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            /* @__PURE__ */ jsx7(By, { id: claim.created_by })
          ] })
        ] })
      });
    }
    for (const exchange of exchanges) {
      ...
      items.push({
        ...
        itemsMap,
        children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          /* @__PURE__ */ jsx7(ExchangeBody, { exchange, exchangeReturn }),
          exchange.created_by && !exchange.canceled_at && /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            /* @__PURE__ */ jsx7(By, { id: exchange.created_by })
          ] })
        ] })
      });
    }
        ...
        items.push({
          title: /* @__PURE__ */ jsx7(
            change_details_tooltip_default,
            {
              ...
              previous: /* @__PURE__ */ jsx7("p", { className: "txt-compact-small text-ui-fg-subtle", children: getFormattedAddress({
                address: update.actions[0].details?.old
              }).join(", ") }),
              next: /* @__PURE__ */ jsx7("p", { className: "txt-compact-small text-ui-fg-subtle", children: getFormattedAddress({
        ...
        items.push({
          title: /* @__PURE__ */ jsx7(
            change_details_tooltip_default,
            {
              ...
              previous: /* @__PURE__ */ jsx7("p", { className: "txt-compact-small text-ui-fg-subtle", children: update.actions[0].details?.old }),
              next: /* @__PURE__ */ jsx7("p", { className: "txt-compact-small text-ui-fg-subtle", children: update.actions[0].details?.new })
            }
          ),
          timestamp: update.created_at,
          children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle mt-2 flex gap-x-2 text-sm", children: [
    ...
    if (initialOrder.created_at) {
      const createdAt = {
        ...
        children: /* @__PURE__ */ jsx7(Text6, { size: "small", className: "text-ui-fg-subtle", children: getStylizedAmount(initialOrder.total, initialOrder.currency_code) })
      };
...
var OrderEditBody = ({ edit }) => {
  ...
  const userId = isConfirmed ? edit.confirmed_by : isDeclined ? edit.declined_by : isCanceled ? edit.canceled_by : edit.requested_by;
  ...
  const ItemChangeDetails = ({
    ...
    const deletedItemIdsSet = new Set(
      itemChange.detail.filter((item) => item.isDeleted).map((item) => item.lineItemId)
    );
    const isAllDeleted = deletedItemIdsSet.size === itemChange.detail.length;
    const isSomeDeleted = deletedItemIdsSet.size > 0;
    const { isLoading: isLoadingDeleted, order_items: deletedLineItems = [] } = useOrderLineItems(
      edit.order_id,
      {
    ...
    const { isLoading, order_items: nonDeletedLineItems = [] } = useOrderLineItems(
      edit.order_id,
      {
        item_id: itemChange.detail.filter((item) => !deletedItemIdsSet.has(item.lineItemId)).map((item) => item.lineItemId),
        version
      },
      {
    ...
    const label = itemChange.type === "added" ? t("labels.added") : t("labels.removed");
    if (isLoading || isLoadingDeleted) {
      return /* @__PURE__ */ jsx7(Text6, { size: "small", className: "text-ui-fg-subtle", children: t("labels.loading") });
    }
    return /* @__PURE__ */ jsx7("div", { className: "text-ui-fg-subtle flex flex-col divide-y divide-dashed", children: lineItems.map((orderItem) => {
      ...
      return /* @__PURE__ */ jsxs8(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx7(Thumbnail, { src: lineItem.thumbnail }),
            /* @__PURE__ */ jsxs8("div", { children: [
              ...
              lineItem.variant_sku && /* @__PURE__ */ jsx7(Text6, { size: "small", children: lineItem.variant_sku }),
              /* @__PURE__ */ jsx7(Text6, { size: "small", children: `${label}: ${itemChangeItem.count}` })
            ] })
          ]
        },
        orderItem.item_id
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col items-start gap-y-2", children: [
    itemsAdded.totalCount > 0 && /* @__PURE__ */ jsx7(
      change_details_tooltip_default,
      {
        title: `${t("labels.added")}: ${itemsAdded.totalCount}`,
        previous: /* @__PURE__ */ jsx7(ItemChangeDetails, { itemChange: itemsAdded, version: edit.version })
      }
    ),
    itemsRemoved.totalCount > 0 && /* @__PURE__ */ jsx7(
      change_details_tooltip_default,
      {
        title: `${t("labels.removed")}: ${itemsRemoved.totalCount}`,
        previous: /* @__PURE__ */ jsx7(
          ItemChangeDetails,
          {
    ...
    edit.internal_note && /* @__PURE__ */ jsx7("div", { className: "bg-ui-bg-component shadow-borders-base mt-2 w-fit rounded-r-2xl rounded-bl-md rounded-tl-xl px-3 py-1.5", children: /* @__PURE__ */ jsx7(Text6, { size: "xsmall", className: "text-ui-fg-subtle", children: edit.internal_note }) }),
    userId && /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 text-sm", children: [
      t("fields.by"),
      " ",
      /* @__PURE__ */ jsx7(By, { id: userId })
    ] })
  ] });
};
...
function countItemsChange(actions) {
  ...
  actions.forEach((action) => {
    if (action.action === "ITEM_ADD") {
      addedChange.totalCount += action.details.quantity;
      addedChange.detail.push({
        lineItemId: action.details.reference_id,
        count: action.details.quantity
      });
    }
...
var Fulfillment = ({
  ...
  const [sendNotification, setSendNotification] = useState4(
    !order.no_notification
  );
  const [showDeliveredPrompt, setShowDeliveredPrompt] = useState4(false);
  ...
  return /* @__PURE__ */ jsxs12(Container7, { className: "divide-y p-0", children: [
    ...
    /* @__PURE__ */ jsx11(Prompt, { open: showDeliveredPrompt, variant: "confirmation", children: /* @__PURE__ */ jsxs12(Prompt.Content, { children: [
      /* @__PURE__ */ jsxs12(Prompt.Header, { children: [
        /* @__PURE__ */ jsx11(Prompt.Title, { children: t("general.areYouSure") }),
        /* @__PURE__ */ jsx11(Prompt.Description, { children: t("orders.fulfillment.markAsDeliveredWarning") })
      ] }),
      /* @__PURE__ */ jsxs12("div", { className: "border-ui-border-base mt-6 flex items-center justify-between border-y border-dotted p-6", children: [
        /* @__PURE__ */ jsx11(
          Label,
          {
            htmlFor: `send-notification-${fulfillment.id}`,
            className: "txt-compact-small text-ui-fg-subtle",
            children: t("orders.returns.sendNotification")
          }
        ),
        /* @__PURE__ */ jsx11(
          Switch,
      ...
      /* @__PURE__ */ jsxs12(Prompt.Footer, { children: [
        /* @__PURE__ */ jsx11(Prompt.Cancel, { onClick: handleCancelDeliveredPrompt, children: t("actions.cancel") }),
        /* @__PURE__ */ jsx11(Prompt.Action, { onClick: handleConfirmDelivered, children: t("actions.continue") })
      ] })
    ] }) })
  ] });
};
...
var PendingAuthorizationBanner = ({
  order,
  sessionId
}) => {
  const { t } = useTranslation14();
  ...
  const handleCheckStatus = async () => {
    await mutateAsync(void 0, {
      onSuccess: ({ is_authorized }) => {
        if (is_authorized) {
          toast9.success(t("orders.payment.checkStatusSuccess"));
        } else {
          toast9.info(t("orders.payment.stillPending"));
        }
      },
      onError: (error) => {
        toast9.error(error.message);
  ...
  return /* @__PURE__ */ jsxs15("div", { className: "bg-ui-bg-subtle flex items-center justify-between px-6 py-4", children: [
    /* @__PURE__ */ jsxs15("div", { className: "flex items-center gap-x-2", children: [
      /* @__PURE__ */ jsx14(ArrowDownRightMini, { className: "text-ui-fg-muted shrink-0" }),
      /* @__PURE__ */ jsx14(Text10, { size: "small", leading: "compact", children: t("orders.payment.pendingAuthorization") })
    ] }),
    /* @__PURE__ */ jsx14(
      Button7,
      {
        ...
        disabled: isPending,
        children: t("orders.payment.checkStatus")
      }
    )
  ] });
};
var PaymentBreakdown = ({
  ...
  const pendingAuthSessions = (order.payment_collections ?? []).flatMap(
    (pc) => (pc.payment_sessions ?? []).filter((s) => s.status === "pending_authorization").map((s) => ({ session_id: s.id }))
  );
  ...
  return /* @__PURE__ */ jsxs15("div", { className: "flex flex-col divide-y divide-dashed", children: [
    pendingAuthSessions.map(({ session_id }) => /* @__PURE__ */ jsx14(
...
import React, { useState as useState6 } from "react";
...
var CopyPaymentLink = React.forwardRef(
  ({ paymentCollection, order }, ref) => {
    ...
    const [text, setText] = useState6("CopyPaymentLink");
...
function ShippingInfoPopover({ shippingMethod }) {
  ...
  return /* @__PURE__ */ jsx17(
    Tooltip6,
    {
      ...
      children: /* @__PURE__ */ jsx17(InformationCircleSolid2, { className: "text-ui-fg-muted ml-1 inline-block" })
    }
  );
}
...
var Item = ({
  ...
  const hasInventoryKit = isInventoryManaged && ((item.variant?.inventory_items?.length || 0) > 1 || item.variant?.inventory_items?.some(
  ...
  return /* @__PURE__ */ jsxs19(Fragment3, { children: [
    /* @__PURE__ */ jsxs19(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs19("div", { className: " flex justify-between gap-x-2 ", children: [
            /* @__PURE__ */ jsxs19("div", { className: " group flex items-start gap-x-4", children: [
            ...
            appliedPromoCodes.length > 0 && /* @__PURE__ */ jsx18(
              Tooltip7,
              {
                content: /* @__PURE__ */ jsx18("span", { className: "text-pretty", children: appliedPromoCodes.map((code) => /* @__PURE__ */ jsx18("div", { children: code }, code)) }),
                children: /* @__PURE__ */ jsx18(ReceiptPercent, { className: "text-ui-fg-subtle flex-shrink self-center " })
              }
            )
          ] }),
...
var CostBreakdown = ({
  ...
  const { t } = useTranslation18();
  const [isTaxOpen, setIsTaxOpen] = useState8(false);
  const [isShippingOpen, setIsShippingOpen] = useState8(false);
...
var DiscountAndTotalBreakdown = ({
  ...
  const { t } = useTranslation18();
  const [isDiscountOpen, setIsDiscountOpen] = useState8(false);
  const [isCreditLinesOpen, setIsCreditLinesOpen] = useState8(false);
  const creditLines = order.credit_lines ?? [];
  const loyaltyPlugin = getLoyaltyPlugin(plugins);
...
// src/routes/orders/order-detail/order-detail.tsx
import { Fragment as Fragment4, jsx as jsx19, jsxs as jsxs20 } from "react/jsx-runtime";
var OrderDetail = () => {
  ...
  return /* @__PURE__ */ jsx19(
    LayoutComposer,
    {
      ...
      data: order,
      sections: {
        main: /* @__PURE__ */ jsxs20(Fragment4, { children: [
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "OrderActiveEditSection", children: /* @__PURE__ */ jsx19(OrderActiveEditSection, { order }) }),
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "ActiveOrderClaimSection", children: /* @__PURE__ */ jsx19(ActiveOrderClaimSection, { orderPreview }) }),
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "ActiveOrderExchangeSection", children: /* @__PURE__ */ jsx19(ActiveOrderExchangeSection, { orderPreview }) }),
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "ActiveOrderReturnSection", children: /* @__PURE__ */ jsx19(ActiveOrderReturnSection, { orderPreview }) }),
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "OrderGeneralSection", children: /* @__PURE__ */ jsx19(OrderGeneralSection, { order }) }),
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "OrderSummarySection", children: /* @__PURE__ */ jsx19(OrderSummarySection, { order, plugins }) }),
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "OrderPaymentSection", children: /* @__PURE__ */ jsx19(
            OrderPaymentSection,
            {
              order,
              plugins
          ...
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "OrderFulfillmentSection", children: /* @__PURE__ */ jsx19(OrderFulfillmentSection, { order }) }),
          detailPageDefaultEntries(order)
        ] }),
        side: /* @__PURE__ */ jsxs20(Fragment4, { children: [
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "OrderCustomerSection", children: /* @__PURE__ */ jsx19(OrderCustomerSection, { order }) }),
          /* @__PURE__ */ jsx19(LayoutComposer.Entry, { id: "OrderActivitySection", children: /* @__PURE__ */ jsx19(OrderActivitySection, { order }) })
        ] })
      }
    }
  );
