...
var CountryActions = ({
  ...
  const prompt = usePrompt();
  const { mutateAsync } = useUpdateRegion(region.id);
  const payload = region.countries?.filter((c) => c.iso_2 && c.iso_2 !== country.iso_2).map((c) => c.iso_2);
    ...
    LayoutComposer,
    {
      ...
      sections: {
        main: /* @__PURE__ */ jsxs3(Fragment, { children: [
          /* @__PURE__ */ jsx4(LayoutComposer.Entry, { id: "RegionGeneralSection", children: /* @__PURE__ */ jsx4(
          ...
          /* @__PURE__ */ jsx4(LayoutComposer.Entry, { id: "RegionCountrySection", children: /* @__PURE__ */ jsx4(RegionCountrySection, { region }) }),
