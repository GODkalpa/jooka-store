...
var CreateOrderTransferSchema = zod.object({
  ...
  if (data.type === "guest" && !zod.string().email().safeParse(data.email).success) {
    ctx.addIssue({
      code: zod.ZodIssueCode.custom,
      path: ["email"],
...
function CreateOrderTransferForm({
  ...
  const { mutateAsync: requestTransfer, isPending: isRequestPending } = useRequestTransferOrder(order.id);
  const { mutateAsync: transferToGuest, isPending: isGuestPending } = useTransferOrderToGuest(order.id);
        ...
        /* @__PURE__ */ jsx2(RouteDrawer.Body, { className: "flex-1 overflow-auto", children: /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-y-8", children: [
            ...
            Form.Field,
            {
              ...
              render: ({ field }) => {
                return /* @__PURE__ */ jsxs2(Form.Item, { children: [
                  /* @__PURE__ */ jsx2(Form.Label, { children: t("orders.transfer.ownerType") }),
          ...
          type === "registered" ? /* @__PURE__ */ jsx2(
            ...
            Form.Field,
            {
              ...
              render: ({ field }) => {
                return /* @__PURE__ */ jsxs2(Form.Item, { children: [
                  /* @__PURE__ */ jsx2(Form.Label, { children: t("orders.transfer.newGuestOwner") }),
                  /* @__PURE__ */ jsx2("span", { className: "txt-small text-ui-fg-muted", children: t("orders.transfer.newGuestOwnerDescription") }),
                  /* @__PURE__ */ jsx2(Form.Control, { children: /* @__PURE__ */ jsx2(
                    Input,
                    {
                      type: "email",
