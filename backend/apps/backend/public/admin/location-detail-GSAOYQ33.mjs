...
var LOCATION_DETAILS_FIELD = "name,metadata,*sales_channels,*address,fulfillment_sets.type,fulfillment_sets.name,*fulfillment_sets.service_zones.geo_zones,*fulfillment_sets.service_zones,*fulfillment_sets.service_zones.shipping_options,*fulfillment_sets.service_zones.shipping_options.rules,*fulfillment_sets.service_zones.shipping_options.shipping_profile,*fulfillment_providers";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx2(Container, { className: "p-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx2(Text, { className: "text-ui-fg-subtle txt-small", children: getFormattedAddress({
...
var LocationDetail = () => {
  ...
  return /* @__PURE__ */ jsx5(
    LayoutComposer,
    {
      ...
      data: location,
      sections: {
        main: /* @__PURE__ */ jsxs4(Fragment3, { children: [
          /* @__PURE__ */ jsx5(LayoutComposer.Entry, { id: "LocationGeneralSection", children: /* @__PURE__ */ jsx5(LocationGeneralSection, { location }) }),
          detailPageDefaultEntries(location)
        ] }),
        side: /* @__PURE__ */ jsxs4(Fragment3, { children: [
          /* @__PURE__ */ jsx5(LayoutComposer.Entry, { id: "LocationsSalesChannelsSection", children: /* @__PURE__ */ jsx5(locations_sales_channels_section_default, { location }) }),
          /* @__PURE__ */ jsx5(LayoutComposer.Entry, { id: "LocationsFulfillmentProvidersSection", children: /* @__PURE__ */ jsx5(location_fulfillment_providers_section_default, { location }) })
        ] })
      }
    }
  );
