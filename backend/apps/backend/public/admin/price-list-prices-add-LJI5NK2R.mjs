...
var PriceListPricesAddPricesForm = ({
  ...
  return /* @__PURE__ */ jsx(QuantityPriceModal, { form, products, regions, children: ({ isModalOpen }) => /* @__PURE__ */ jsx("div", { className: "flex size-full flex-col divide-y overflow-hidden", children: /* @__PURE__ */ jsx(
    DataGrid,
    {
      isLoading,
      columns,
