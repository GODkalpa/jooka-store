...
var PriceListPricesForm = ({
  ...
  return /* @__PURE__ */ jsx2(QuantityPriceModal, { form, products, regions, children: ({ isModalOpen }) => /* @__PURE__ */ jsx2("div", { className: "flex size-full flex-col divide-y overflow-hidden", children: /* @__PURE__ */ jsx2(
    DataGrid,
    {
      isLoading,
      columns,
